		...
		<form method="POST" action="<?= htmlspecialchars($_SERVER['PHP_SELF']);?>">
			...
			<section>
				<div>
					...
					<b><font color="#0198D8" size="6">UPDATE STATUS</font></b>
					<br/>
					<br/>
					&emsp;&emsp;&emsp;&emsp;&emsp;
					<b><font color="#0198D8" size="3">Your Profile Updated Successfully !!</font></b>
					&emsp;&emsp;
					<a href="CustomerAccount.php">GO TO PROFILE</a>
				</div>
			</section>
