...
<body>
	...
	<h1 align="left">Sports Item</h1>
	<h2 align="center">DealMart Today's Deal</h2>

  <div class="container">
	<fieldset >
		<legend><b>Hot Deal</b></legend>
		<a href="details_as.php">
		<img src="as.jpg" height="250" width="200" />
		</a>
  ...
  <div class="container">
	<fieldset >
		...
		<a href="details_bs.php">
		<img src="bs.jpg" height="250" width="200" />
		</a>
		<h4>Weight Lifter</h4>
  ...
  <div class="container">
	...
	<fieldset >
		...
		<a href="details_cs.php">
		<img src="cs.jpg" height="250" width="200" />
		</a>
		<h4>Jumping Rope</h4>
  ...
  <div class="container">
	<fieldset >
		<legend><b>Hot Deal</b></legend>
		<a href="details_ds.php">
		<img src="ds.jpg" height="250" width="200" />
		</a>
		<h4>Tennis Bat</h4>
  ...
  <div class="container">
   <fieldset>
		...
		<a href="details_es.php">
		<img src="es.png" height="250" width="200" />
		</a>
		<h4>Tennis Ball</h4>
		<h3>35.5$ <strike>38.75$</strike></h3>
		<input type="button" value="Add to cart">
  ...
  <div class="container">
    <fieldset>
		<a href="details_fs.php">
		<img src="fs.jpg" height="200" width="200" />
		</a>
		<h4>Weight Lifter</h4>
		<h3>35.5$</h3>
		<input type="button" value="Add to cart">
  ...
  <div class="container">
   <fieldset>
		<a href="details_gs.php">
		<img src="gs.jpg" height="200" width="200" />
		</a>
		<h4>Exercise Ball</h4>
		<h3>32$</h3>
		<input type="button" value="Add to cart">
  ...
  <div class="container">
  <fieldset>
		<a href="details_hs.php">
		<img src="hs.jpg" height="200" width="200" />
		</a>
		<h4>Gulf Set</h4>
		<h3>15.5$</h3>
		<input type="button" value="Add to cart">
  ...
  <div class="container">
    <fieldset>
		<a href="details_is.php">
		<img src="is.png" height="200" width="200" />
		</a>
		<h4>Cricket Ball</h4>
		<h3>18$</h3>
		<input type="button" value="Add to cart">
  ...
  <div class="container">
   <fieldset>
		<a href="details_js.php">
		<img src="js.jpg" height="200" width="200" />
		</a>
		<h4>Basket Ball Goalpost</h4>
		<h3>95$</h3>
		<input type="button" value="Add to cart">
	</fieldset>
