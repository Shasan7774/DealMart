<?php
	...
	if(isset($_POST['register']))
	{
		...
		if($fName=="" && $lName=="" && $emailError=="" && $mobError=="" && $nPassError=="" && $cPassError=="" && $addressError=="")
		{
			...
			if($num1==0)
			{
				$addCustomer=addNewCustomer($fname,$lname,$email,$mobile,$nPassword,$address);
				if($addCustomer)
				{
					echo "<script type='text/javascript'>alert('You are Registered, Please Login');</script>";
				}
				
			}
			else
			{
				$sameIdError="This Username Already Exist";
			}
		...
		<form method="POST" action="<?= htmlspecialchars($_SERVER['PHP_SELF']);?>">
			...
			<section>
				<div style="background:#A0DDFA;">
					...
					<br/>
					<br/>
					<img src="images/creat.jpg" style="height:350px; width:600px; float:left;"/>
					<br/>
