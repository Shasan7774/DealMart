		...
		<form method="POST" action="<?= htmlspecialchars($_SERVER['PHP_SELF']);?>">
			...
			<header>
				<div style="background:#ccffff">
					...
					&emsp;&emsp;<b><font color="#800000" size="10">MyShop.com</font></b>
					...
					<input type="submit" value="Cart" name="cart">&emsp;&emsp;&emsp;
			...
			<section>
				<div>
					...
					<b><font color="#0198D8" size="6">Thanks..</font></b>
					<br/>
					<br/>
					<b><font color="#8D4137" size="4">Your order has been completed, Stay with us</font></b>
					<br/>
					<br/>
