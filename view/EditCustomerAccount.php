<?php
	...
	if(isset($_POST['register']))
	{
		...
		{
			$updateCustomer=updateCustomer($fname,$lname,$email,$mobile,$nPassword,$address,$customerId);
			if($updateCustomer)
			{
				header("Location:CustomerAccountUpdateSuccess.php");
			}
			else
			{
			...
			<section>
				<div style="background:#A0DDFA;" align="center">
					...
					<fieldset style="width:600px" align="center">
						...
						<br/>
						<br/>
						<input type="submit" value="CHANGE" name="register" style="height:35px; width:120px; background:red; color:white;"/>
						&nbsp;&nbsp;
						<br/>
						<br/>
						<br/>
