	...
	<body>
		...
		<header>
			<div style="background:#ccffff">
				...
				<input type="text" name="id" style="height:20px; width:400px"/>
				...
				?>		
						<tr align="center">
							...
							<td>
								...
								?>
								<a href="UpdateProductSessionSetter.php?uid=<?=$productId;?>">Update</a>
								&emsp;
								<a href="DeleteProduct.php?uid=<?=$productId;?>">Delete</a>
							</td>
						</tr>
			<?php				
				}
